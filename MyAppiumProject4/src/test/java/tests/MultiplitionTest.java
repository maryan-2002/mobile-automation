...
public class MultiplitionTest {
    ...
    final String multiply = "com.simplemobiletools.calculator:id/btn_multiply";
    ...
    @Test
    public void multiplyTwoPositiveIntegers() { // TC041
        click(five);
        click(multiply);
        click(five);
        click(eq);
    ...
    @Test
    public void multiplyTwoNegativeIntegers() { // TC042
        click(neg);
        click(five);
        click(multiply);
        click(neg);
    ...
    @Test
    public void negativeMultiplyPositive() { // TC043
        click(neg);
        click(five);
        click(multiply);
        click(five);
    ...
    @Test
    public void positiveMultiplyNegative() { // TC044
    ...
    @Test
    public void zeroMultiplyPositive() { // TC045
        click(zero);
        click(multiply);
        click(five);
        click(eq);
    ...
    @Test
    public void zeroMultiplyNegative() { // TC046
        click(zero);
        click(multiply);
        click(neg);
        click(five);
    ...
    @Test
    public void positiveMultiplyZero() { // TC047
        click(five);
        click(multiply);
        click(zero);
        click(eq);
    ...
    @Test
    public void negativeMultiplyZero() { // TC048
        click(neg);
        click(five);
        click(multiply);
        click(zero);
    ...
    @Test
    public void zeroMultiplyZero() { // TC049
        click(zero);
        click(multiply);
        click(zero);
        click(eq);
    ...
    @Test
    public void integerMultiplyFloat() { // TC050
        click(five);
        click(multiply);
        click(five);
        click(dec);
